...
class _ReelsPageState extends State<ReelsPage> {
  ...
  void initState() {
    ...
    pageKeys = List.generate(
        widget.reels.length, (_) => GlobalKey<_ReelPlayerState>());
  }
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => AddDetailsPage(videoFile: recordedVideo),
                    ),
                  );
                },
              ),
...
// }
  ...
  Future<void> likeReel() async {
    try {
      ...
      final url = "https://app.pawdli.com/user/short_video/$reelId/like/";
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  if (Platform.isIOS) {
                    message = "Download Pawdli App From IOS Store👇\n"
                    ...
                    message = "Download Pawdli App From Play Store👇\n"
                        "https://play.google.com/store/apps/details?id=com.ivyis.pawlli\n\n"
                        "Download Pawdli App From IOS Store👇\n"
                        "https://apps.apple.com/in/app/pawdli/id6747665709";
                  }

                  Share.share(message, subject: "Pawdli App Download");
                ...
                if (widget.reel.caption.isNotEmpty)
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      final textPainter = TextPainter(
                        text: TextSpan(
                            text: widget.reel.caption, style: textStyle),
                        maxLines: 1,
                        textDirection: TextDirection.ltr,
