...
class _RadioProgramPageState extends State<RadioProgramPage> {
  ...
  final PayThroughWalletController walletController =
      Get.put(PayThroughWalletController());
                        ...
                        children: [
                          ...
                          Card(
                            shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(
                                  color: Colours.primarycolour, width: 1),
                            ),
                            elevation: 5,
                            child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                border: OutlineInputBorder(
                                  ...
                                  borderSide:
                                      BorderSide(color: Colours.textColour),
                                ),
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(12),
                                  borderSide:
                                      BorderSide(color: Colours.primarycolour),
                                ),
                              ),
                            ),
                          ),
                              ...
                              Expanded(
                                child: RadioListTile<String>(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    print(
                                        "🔁 PROGRAM MODE CHANGED: $programMode");
                                  },
                                ),
                              ),
                              Expanded(
                          ...
                          Center(
                            child: ToggleSwitch(
                              ...
                              onToggle: (index) async {
                                ...
                                print(
                                    "🎥 PROGRAM TYPE CHANGED: $selectedProgramType");
                                print(
                                    "🎭 PROGRAM MODE (Live/Recorded): $programMode");
                                    ...
                                    children: [
                                      ...
                                      if (isUploading) ...[
                                        ...
                                        LinearProgressIndicator(
                                          value:
                                              uploadProgress, // ← Controlled from upload function
                                          minHeight: 6,
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              if (programMode == 'Live') {
                                ...
                                print(
                                    "📼 RECORDED FLOW → CALL uploadSelectedFile()");
