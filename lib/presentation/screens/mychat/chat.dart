...
class _MyChatsSectionState extends State<_MyChatsSection> {
  ...
  final RecentPetChatController recentChatController =
      Get.find<RecentPetChatController>();
          ...
          return SingleChildScrollView(
            ...
            child: Row(
              children: petsController.userPets.map((pet) {
                final isSelected = recentChatController.selectedPetId.value ==
                    pet.petId.toString();
                ...
                return GestureDetector(
                    onTap: () {
                      ...
                      recentChatController
                          .fetchRecentChatsForPet(selectedPetId);
                    },
                    child: Container(
                              ...
                              Center(
                                child: CircleAvatar(
                                  ...
                                  child: fullPetImage.isEmpty
                                      ? Icon(Icons.pets,
                                          size: 30, color: Colours.brownColour)
                                      : null,
                                ),
                              ),
            ...
            return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final backgroundAsset = (index % 2 == 0)
                      ...
                      : 'https://pawlli-podcasts.s3.ap-south-1.amazonaws.com/static_images/chatbrowncard.png';
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => Chat1to1(
                            ...
                            petId: int.parse(
                                recentChatController.selectedPetId.value),
                          ),
                        ),
                      );
                    },
