...
class _MyWalletPageState extends State<MyWalletPage> {
  final WalletBalanceController walletController =
  ...
  void _startRazorpayPayment(int amount) async {
    try {
      ...
      await topUpController.topUpWallet(
        userId:
            userId!, // Replace with actual userId (maybe from local storage)
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    try {
      ...
      if (verification != null) {
        debugPrint(
            "✅ Payment verification successful, refreshing wallet and transactions.");
...
// ✅ Top Up Section (removed Platform.isAndroid)
                          ...
                          Obx(() {
                            ...
                            var transactions = transactionController
