...
class Meetvetslot extends StatefulWidget {
  ...
  const Meetvetslot(
      {super.key, required this.petid, required this.selectedDate});

  @override
  State<Meetvetslot> createState() => _MeetvetslotPageState();
}

class _MeetvetslotPageState extends State<Meetvetslot> {
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: NetworkImage(
                          'https://pawlli-podcasts.s3.ap-south-1.amazonaws.com/static_images/dogcat.png'),
                    ),
                            ...
                            children: [
                              ...
                              Container(
                                padding: EdgeInsets.symmetric(
                                    horizontal: 12, vertical: 6),
                                decoration: BoxDecoration(
                                  color: Colours.brownColour.withOpacity(0.1),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                                  "15+ Years",
