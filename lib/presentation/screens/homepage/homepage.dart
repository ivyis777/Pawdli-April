...
import 'package:pawlli/presentation/screens/pet_store/Store_Orders/orders_list.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final bool isSuperUser = GetStorage().read('is_superuser') ?? false;
              ...
              child: GestureDetector(
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      left:
                          screenWidth * 0.05, // Adjust the horizontal position
...
//   ),
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        top:
                            screenHeight * 0.02, // Adjust the vertical position
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(
              ...
              child: GestureDetector(
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      right:
                          screenWidth * -0.12, // Adjust the horizontal position
            ...
            Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: screenWidth * 0.010), // Adjust for side padding
              child: Row(
                mainAxisAlignment: MainAxisAlignment
                    .spaceAround, // Equal spacing between widgets
                crossAxisAlignment:
                    CrossAxisAlignment.start, // Vertically align widgets
                children: [
                  // "All" Category
                  Flexible(
                    flex: 1,
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AdoptionViewList()),
                              ).then((_) {
