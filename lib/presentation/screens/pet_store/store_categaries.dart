...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  final StoreSearchController searchController =
      Get.find<StoreSearchController>(); // ✅ ADD THIS
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        isSelected ? Colours.primarycolour : Colors.transparent,
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final image = p.productImages?.isNotEmpty == true
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    // 🧪 DEBUG LOG
                    debugPrint("🛒 CART BADGE DEBUG → count=$count");
