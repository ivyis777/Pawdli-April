...
class _PetstorePageState extends State<PetstorePage> {
  ...
  Future<void> loadInitialData() async {
    ...
    if (_categoryController.categories.isNotEmpty) {
      categoryHints =
          _categoryController.categories.map((e) => e.name ?? '').toList();
            ...
            return GestureDetector(
              onTap: () {
                ...
                _subCategoryController
                    .loadSubCategories(category.storeCategoryId ?? 1);
              },
              child: isCollapsed
    ...
    return Padding(
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? Colours.primarycolour : Colors.grey.shade200,
            borderRadius: BorderRadius.circular(25),
          ),
          child: Text(
            name,
