...
class _MypaymentsPageState extends State<MypaymentsPage> {
  final PaymentTransactionController paymentController =
      Get.put(PaymentTransactionController());
                ...
                child: GetBuilder<PaymentTransactionController>(
                  builder: (controller) {
                    ...
                    final filteredPayments = payments.where((payment) {
                      ...
                      final paymentDateOnly = DateFormat('dd-MM-yyyy')
                          .format(payment.transactionDate);

                      bool typeFilter = selectedPaymentType == 'All' ||
                          selectedPaymentType == null ||
                          paymentType == selectedPaymentType;
                      bool dateFilter = selectedPaymentDate == null ||
                          paymentDateOnly == selectedPaymentDate;
                          ...
                          children: [
                            ...
                            if (filteredPayments.isEmpty)
                              ...
                              ...filteredPayments.map((payment) {
                                final dateStr =
                                    formatToIST(payment.transactionDate);
                                return Container(
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            ...
                                            if (pdfFile != null) {
                                              ...
                                              print(
                                                  "⚠️ Could not download or open the PDF.");
                                            }
                                          },
