...
class _EditPetPageState extends State<EditPetPage> {
  ...
  final UpdatePetController updatePetController =
      Get.put(UpdatePetController());
    ...
    try {
      ...
      if (petDetails != null) {
        ...
        setState(() {
          ...
          if (petDetails.petProfileImage != null &&
  ...
  Future<File?> _compressImage(XFile image) async {
    ...
    final lastIndex =
        filePath.lastIndexOf(RegExp(r'.jp')); // works for .jpg, .jpeg
    ...
    return Obx(() {
      ...
      return Padding(
        ...
        child: DropdownButtonFormField<String>(
          value:
              validCategoryNames.contains(_selectedType) ? _selectedType : null,
