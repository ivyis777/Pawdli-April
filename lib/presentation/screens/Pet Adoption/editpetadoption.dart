...
class _EditAdoptionPetPageState extends State<EditAdoptionPetPage> {
  ...
  final AllCategoriesController _categoryController =
      Get.put(AllCategoriesController());
  final AllSubCategoriesController subCategoryController =
      Get.put(AllSubCategoriesController());
  final UpdateAdoptionPetController updateAdoptionPetController =
      Get.put(UpdateAdoptionPetController());
  ...
  TextEditingController _heightController =
      TextEditingController(); // Height controller
      ...
      if (petDetails != null) {
        ...
        if (_selectedCategoryId != null) {
          await subCategoryController
              .fetchAllsubCategories(_selectedCategoryId!);
        ...
        setState(() {
          ...
          _networkImageUrl = petDetails.petProfileImage != null &&
                  petDetails.petProfileImage!.isNotEmpty
        ...
        if (petDetails.mobileNumber?.isNotEmpty == true) {
          ...
          PhoneNumber.getRegionInfoFromPhoneNumber(sanitizedMobile)
              .then((phone) {
            setState(() {
              _phoneNumber = phone;
        ...
        children: <Widget>[
          ...
          ToggleSwitch(
            ...
            onToggle: (index) {
              ...
              print(
                  'Updated Status - isAvailable: $_isAvailable, isSoldout: $_isSoldout');
            },
          ),
        ],
      ),
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: NetworkImage(
                'https://pawlli-podcasts.s3.ap-south-1.amazonaws.com/static_images/topimage.png'), // Ensure the correct path
            fit: BoxFit.cover,
          ),
        ),
      ),
                    ...
                    inputDecoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: Colours.primarycolour, width: 2.0),
                        borderRadius: BorderRadius.circular(10),
                      ),
                    ),
                  ),
...
//                         _buildBreedDropdown(),
  ...
  Future<Editadoptionmodel?> _updatePetProfile() async {
    ...
    return await updateAdoptionPetController.updatePet(
        model, widget.Id.toString());
  }
}
