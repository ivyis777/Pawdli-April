...
import 'package:pawlli/presentation/screens/language/languages.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final Uri termsUrl =
      Uri.parse('https://www.pawlli.com/terms-and-conditions/');
  ...
  Widget build(BuildContext context) {
    ...
    final String fullImageUrl =
        profilePic != null && profilePic.isNotEmpty ? profilePic : '';
    return WillPopScope(
        onWillPop: () async {
  ...
  Widget _buildSection(BuildContext context,
      {required String title, required VoidCallback onTap, IconData? icon, TextOverflow? overflow}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            if (icon != null)
              Icon(icon, color: Colors.brown.shade800, size: 24),
