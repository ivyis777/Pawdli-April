...
class SlotPaymentfailure extends StatefulWidget {
  ...
  @override
  State<SlotPaymentfailure> createState() => _SlotPaymentfailureState();
}

class _SlotPaymentfailureState extends State<SlotPaymentfailure> {
  late String amount;
  late String orderId;
  late String date;
