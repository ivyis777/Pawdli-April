...
class SlotPaymentsuccess extends StatefulWidget {
  final String orderId;
  final String? paymentId;
  final String? signature;
  final int? radioid;
  final String radioname;
  const SlotPaymentsuccess(
      {super.key,
  ...
  @override
  State<SlotPaymentsuccess> createState() => _SlotPaymentsuccessState();
}

class _SlotPaymentsuccessState extends State<SlotPaymentsuccess> {
