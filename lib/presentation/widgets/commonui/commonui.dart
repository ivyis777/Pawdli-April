      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: -24,
            child: Image.network(
              'https://pawlli-podcasts.s3.ap-south-1.amazonaws.com/static_images/commonimagefirst.png',
          ...
          if (!isKeyboardOpen)
            Positioned(
              ...
              left: 0,
              child: Image.network(
                'https://pawlli-podcasts.s3.ap-south-1.amazonaws.com/static_images/commonimagesecond.png',
                width: screenWidth,
